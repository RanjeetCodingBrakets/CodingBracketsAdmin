      ...
      <ul class="nav navbar-nav">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tabs">
                  ...
                  <div class="media media-sm bg-warning-10 p-4 mb-0">
                    <div class="media-sm-wrapper">
                      <a href="">
                        <img src="/assets/static/images/user/user-sm-02.jpg" alt="User Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <a href="">
                        <span class="title mb-0">Ranjeet</span>
                  ...
                  <div class="media media-sm p-4 mb-0">
                    <div class="media-sm-wrapper">
                      <a href="">
                        <img src="/assets/static/images/user/user-sm-03.jpg" alt="User Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <a href="">
                ...
                <div class="tab-pane fade" id="message" role="tabpanel" aria-labelledby="message-tab">
                  ...
                  <div class="media media-sm p-4 mb-0">
                    <div class="media-sm-wrapper">
                      <a href="">
                        <img src="/assets/static/images/user/user-sm-01.jpg" alt="User Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <a href="">
                  ...
                  <div class="media media-sm bg-warning-10 p-4 mb-0">
                    ...
                    <div class="media-body">
                      <a href="">
                        <span class="title mb-0">{{$admin->name}}</span>
                  ...
                  <div class="media media-sm p-4 mb-0">
                    <div class="media-sm-wrapper">
                      <a href="">
                        <img src="/assets/static/images/user/user-sm-04.jpg" alt="User Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <a href="">
        ...
        <li class="dropdown user-menu">
          <button class="dropdown-toggle nav-link" data-toggle="dropdown">
            <img src="/assets/static/images/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
            <span class="d-none d-lg-inline-block">{{$admin->name}}</span>
          </button>
          <ul class="dropdown-menu dropdown-menu-right">
            <li>
              <a class="dropdown-link-item" href="/admin/my-profile">
                <i class="mdi mdi-account-outline"></i>
                <span class="nav-text" >My Profile</span>
              </a>
            </li>
            <li class="dropdown-footer">
              <a class="dropdown-link-item" href="/admin/logout"> <i class="mdi mdi-logout"></i> Log Out </a>
            </li>
          </ul>
        </li>
      </ul>
