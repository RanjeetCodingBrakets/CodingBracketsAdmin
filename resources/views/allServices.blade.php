                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <table id="productsTable" class="table table-hover table-product"
                                        ...
                                        <tbody>
                                            @foreach ($service as $userData)
                                                <tr>
                                                    <td>{{ $userData->id }}</td>
                                                    <td><img src="{{ asset('/admin/' . $userData->banner_img) }}"></td>
                                                    <td>{{ $userData->name }}</td>
                                                    <td>{{ $userData->createdAt }}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group mr-3 mb-4" role="group"
                                                            aria-label="Basic example">
                                                            <!-- Button for Updating the Services -->
                                                            <button onclick="updateService({{ $userData->id }})"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <!-- Button for deleting the services -->
                <a href="all-services/{{ $userData->id }}" class="mb-1 btn btn-danger">Yes</a>
